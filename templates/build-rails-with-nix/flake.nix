{
  ...
  inputs = {
    ...
    yarn2nix.inputs.nixpkgs.follows = "nixpkgs";
  };
  ...
  outputs = {
    ...
    system = "x86_64-linux";
    overlays = [nixpkgs-ruby.overlays.default yarn2nix.overlays.default];
    pkgs = import nixpkgs {
    ...
    nodeModules = pkgs.yarn2nix-moretea.mkYarnPackage {
    ...
    generate-dependencies-script = pkgs.writeShellScriptBin "generate-dependencies" (import (rails-builder + /imports/generate-dependencies.nix));
    ...
    builderExtraInputs =
      ...
      ++ [
        ...
        self.packages.${system}.generate-dependencies-script
      ];
