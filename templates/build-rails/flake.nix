{
  ...
  outputs = {
    ...
    make-rails-app-script = pkgs.writeShellScriptBin "make-rails-app" (import (rails-builder + /imports/make-rails-app-script.nix) {inherit pkgs rubyPackage tbundlerVersion rubyMajorMinor;});
